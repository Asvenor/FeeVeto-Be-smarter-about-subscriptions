...
- **Not verified / release blockers:** browser policy checking is unavailable, so desktop/mobile visual behavior and real Clerk save/sign-in have not been tested. The same issue blocks the approved Stripe branding and sandbox webhook/secret setup. Local preview has no Clerk credentials; its guest flow works. Account-history deletion/export is a disclosed product limitation requiring review before public launch.
